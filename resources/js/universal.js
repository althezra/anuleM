var LunaLoader = function(document, location) {
    ...
    function isPreloadable(a) {
      ...
      if (a.target
          ...
          || (a.href.indexOf('#') > -1
              && removeHash(a.href) == $currentLocationWithoutHash)
          || ($useWhitelist
              ? !isWhitelisted(a)
              : isBlacklisted(a))
         ) {
    ...
    function changePage(title, body, newUrl, scrollY) {
      ...
      userscriptEvent.initEvent('lunaloader:newpage', true, true)
    ...
    var bar = function() {
      ...
      function init() {
        ...
        $barContainer.id = 'lunaloader'
        $barElement = document.createElement('div')
        $barElement.id = 'lunaloader-bar'
        $barElement.className = 'lunaloader-bar'
        ...
        style.innerHTML = '#lunaloader{position:' + ($hasTouch ? 'absolute' : 'fixed') + ';top:0;left:0;width:100%;pointer-events:none;z-index:2147483647;' + transitionProperty + ':opacity .25s .1s}'
          + '.lunaloader-bar{background:#302995;width:100%;margin-left:-100%;height:2px;' + transitionProperty + ':all .25s}'
